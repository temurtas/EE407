 ...
 */
#ifndef RTW_HEADER_q_hfe_on_off_h_
#define RTW_HEADER_q_hfe_on_off_h_
#ifndef q_hfe_on_off_COMMON_INCLUDES_
# define q_hfe_on_off_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* q_hfe_on_off_COMMON_INCLUDES_ */

#include "q_hfe_on_off_types.h"
...
#define q_hfe_on_off_rtModel           RT_MODEL_q_hfe_on_off
...
typedef struct {
  ...
  real_T HILWriteAnalog_Buffer[2];     /* '<S1>/HIL Write Analog' */
...
#define rtB                            q_hfe_on_off_B
#define BlockIO                        BlockIO_q_hfe_on_off
#define rtXdot                         q_hfe_on_off_Xdot
#define StateDerivatives               StateDerivatives_q_hfe_on_off
#define tXdis                          q_hfe_on_off_Xdis
#define StateDisabled                  StateDisabled_q_hfe_on_off
#define rtP                            q_hfe_on_off_P
#define Parameters                     Parameters_q_hfe_on_off
#define rtDWork                        q_hfe_on_off_DWork
#define D_Work                         D_Work_q_hfe_on_off

/* Parameters (auto storage) */
struct Parameters_q_hfe_on_off_ {
...
extern Parameters_q_hfe_on_off q_hfe_on_off_P;

/* Block signals (auto storage) */
extern BlockIO_q_hfe_on_off q_hfe_on_off_B;

/* Block states (auto storage) */
extern D_Work_q_hfe_on_off q_hfe_on_off_DWork;

/* Model entry point functions */
extern void q_hfe_on_off_initialize(boolean_T firstTime);
extern void q_hfe_on_off_output(int_T tid);
extern void q_hfe_on_off_update(int_T tid);
extern void q_hfe_on_off_terminate(void);

/* Real-time Model object */
extern RT_MODEL_q_hfe_on_off *q_hfe_on_off_M;
 ...
 *
 * '<Root>' : q_hfe_on_off
 * '<S1>'   : q_hfe_on_off/Heatflow
 */
#endif                                 /* RTW_HEADER_q_hfe_on_off_h_ */
