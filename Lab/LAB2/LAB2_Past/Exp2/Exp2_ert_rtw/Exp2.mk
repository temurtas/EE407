###########################################################################
## Makefile generated for Simulink model 'Exp2'. 
## 
## Makefile     : Exp2.mk
## Generated on : Sat Nov 24 12:02:05 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Exp2.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/user/Desktop/Exp2
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = Exp2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Exp2.elf
...
DEFINES_STANDARD = -DMODEL=Exp2 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SPIwriteRead.o MW_arduinoI2C.o Exp2.o Exp2_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_zcfcn.o updown.o ext_work.o rtiostream_utils.o wiring_pulse.S.o hooks.o WInterrupts.o wiring.o wiring_analog.o wiring_digital.o wiring_pulse.o wiring_shift.o abi.o CDC.o HardwareSerial.o HardwareSerial0.o HardwareSerial1.o HardwareSerial2.o HardwareSerial3.o PluggableUSB.o IPAddress.o new.o Print.o Stream.o Tone.o USBCore.o WMath.o WString.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o Wire.o twi.o SPI.o
...
%.o : $(START_DIR)/Exp2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/Exp2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
SPI.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/hardware/arduino/avr/libraries/SPI/src/SPI.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
